<%-- Document : ProdutoDados Created on : 11 de nov. de 2024, 20:52:34 Author : alberth --%>
    ...
    <%@page contentType="text/html" pageEncoding="UTF-8" %>
      <% String acao="incluir" ; %>
        ...
        <head>
          ...
          <title>
            <%= acao=="incluir" ? "Adicionar" : "Editar" %> Produto
          </title>
                              ...
                              <% } %>
                                ...
                                <div class="mb-3">
                                  ...
                                  <input type="number" min="1" id="quantidade" name="quantidade"
                                    value="<%= quantidade %>" class="form-control" />
                                </div>

                                <div class="mb-3">
                                  <label for="precoVenda" class="form-label">Preço de Venda </label>
                                  <input type="number" step="0.01" min="0" id="precoVenda" name="precoVenda"
                                    value="<%= precoVenda %>" class="form-control" />
                                </div>
